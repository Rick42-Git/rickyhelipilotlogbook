    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl max-h-[85vh] overflow-y-auto">
        ...
        <div className="space-y-1">
          {/* Header */}
          <div className="grid grid-cols-[36px_110px_70px_70px_1fr_65px_65px_65px_65px_65px_65px_50px_28px] gap-1 font-mono text-[9px] text-muted-foreground uppercase tracking-wider border-b border-border pb-1">
